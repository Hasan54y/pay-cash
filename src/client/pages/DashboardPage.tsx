...
export default function DashboardPage() {
  ...
  const payLink = `https://realcash.online/pay/${user.username}`;
            ...
            <div>
              ...
              <div className="section-stack" style={{ maxWidth: 460 }}>
                <div className="card" style={{ padding: 20 }}>
                  ...
                  <p style={{ fontSize: 13, color: "var(--text-muted)", textAlign: "center", marginBottom: 16 }}>realcash.online/pay/{user.username}</p>
                ...
                <a href={payLink} target="_blank" rel="noreferrer" className="card"
                  ...
                  <div>
                    ...
                    <p style={{ fontSize: 13, color: "var(--text-muted)" }}>realcash.online/pay/{user.username}</p>
                  </div>
